                            ...
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        ...
                                        html.P(
                                            "Community areas", className="card-text"
                                        ),
                                        dbc.Tooltip(
                            ...
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        ...
                                        html.P(
                                            id="schools-subtext", className="card-text"
                                        ),
                                        dbc.Tooltip(
                            ...
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        ...
                                        html.P(
                                            id="crimes-subtext", className="card-text"
                                        ),
                                        dbc.Tooltip(
        ...
        [
                    ...
                    html.Div(
                        children=[
                            html.H1(
                                [
                                    html.Span(
                                        "High School Dropout Rate and crime by location",
                                        style={
                                            "color": "#000000",
                                            "font-weight": "normal",
                                        },
            ...
            dbc.Col(
                [
                    ...
                    html.Div(
                        id="scatter-graph-container", style={"marginBottom": "20px"}
                    ),
                ],
                width=6,
            ),
