...
from merge_shp import load_pumas_shp
import pathlib
...
schools_csv_path = pathlib.Path("data/merged_school_data.csv")  # update with your CSV path
...
def update_charts(selected_year, selected_crime):
   ...
   # Create the scatter plot with a brush selection
    ...
    crime_map = crime_map + point_data_chart(schools_df,2023,
